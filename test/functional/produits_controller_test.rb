...
class ProduitsControllerTest < ActionController::TestCase
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post :create, produit: { commande_id: @produit.commande_id, plat_id: @produit.plat_id, quantity: @produit.quantity }
    end
  ...
  test "should update produit" do
    put :update, id: @produit, produit: { commande_id: @produit.commande_id, plat_id: @produit.plat_id, quantity: @produit.quantity }
    assert_redirected_to produit_path(assigns(:produit))
  end
